...
# Load the base malariasimulationGD parameter set:
...
# Load the base malariasimulationGD parameter set, with seasonal transmission:
simparams <- get_parameters(
  overrides = list(
...
### Simulation
We can now use our lists of `malariasimulationGD` parameters to run the simulations.
