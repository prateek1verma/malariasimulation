...
The vector model in malariasimulationGD initialises vector species
...
All of these phenomena can be captured in malariasimulationGD using a
...
In malariasimulationGD, we can also modify the carrying capacity over time in a more
